...
urlpatterns += [
    ...
    url(
        r"^get_replies_for_tweet/(?P<username>[a-zA-Z]+)/(?P<tweet_id>[0-9]+)/$",
        bot_api_views.get_replies_for_tweet,
    ),
    url(
        r"^get_tweets_over_threshold_and_analyze_text_understanding/(?P<username>[a-zA-Z]+)/(?P<threshold>[0-9]+)/(?P<response_number>[0-9]+)/(?P<scrape_mode>[a-zA-Z_]+)/$",
...
urlpatterns += [
    url(
        r"^get_conversation/(?P<bot1_username>[a-zA-Z0-9_]+)/(?P<bot2_username>[a-zA-Z0-9_]+)/$",
        conversation_api_views.get_conversation,
    ),
    url(
        r"^update_conversation/(?P<bot1_username>[a-zA-Z0-9_]+)/(?P<bot2_username>[a-zA-Z0-9_]+)/(?P<post_number>[0-9]+)/$",
        conversation_api_views.update_conversation,
    ),
    url(
        r"^clear_conversation/(?P<bot1_username>[a-zA-Z_]+)/(?P<bot2_username>[a-zA-Z_]+)/$",
