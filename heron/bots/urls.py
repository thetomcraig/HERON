...
urlpatterns = [
    url(r'^get_bot/(?P<username>[a-zA-Z_]+)/$', api_views.get_bot),
    url(r'^get_all_bots/', api_views.get_all_bots),

    url(r'^scrape_bot/(?P<username>[a-zA-Z]+)/$', api_views.scrape_bot),
    url(r'^scrape_all_bots/$', api_views.scrape_all_bots),
    ...
    url(r'^update_group_conversation/$', api_views.update_group_conversation),
    url(r'^clear_conversation/(?P<bot1_username>[a-zA-Z_]+)/(?P<bot2_username>[a-zA-Z_]+)/$',
        api_views.clear_conversation),
